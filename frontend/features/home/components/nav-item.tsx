    ...
    <Link href={navItem.href}>
      <div
        ...
        className={clsx(
          ...
          isActive
            ? "bg-foreground group text-red-900"
            : "hover:bg-07",
        )}
      >
        <div className="shrink-0 group-hover:text-blue-600">{navItem.icon}</div>
        <span
          className={clsx(
            "whitespace-nowrap text-sm font-medium  group-hover:text-blue-600",
